...
- blog.elcomsoft.com
- Thebinaryhick.blog
- https://www.youtube.com/@MagnetForensics1/videos
...
- ExifTool GUI
- GENA
- Hexinator - HEX EDITOR
- Highligher
- JumpList Explorer
- md5summer
- PhotoRec GUI
- QuickHash - FILE HASHER
- ShadowExplorer
- ShellBags Explorer
- Skype Log View
- SRUM_DUMP
...
# THM
- keywords: forensic, DFIR, AV, malware, reverse engineering, siem.
